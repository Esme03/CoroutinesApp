package com.example.corroitinesapp.ui
...
import com.example.corroitinesapp.R
    ...
    Column(
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                if (changeColor) Color.Green else Color.Red
            )
        ) {
        ...
        Button(onClick = {
            viewModel.cancelTimers()  // Cancelar cronómetros
        }) {
            Text(text = "Cancelar Cronómetros")
        }
